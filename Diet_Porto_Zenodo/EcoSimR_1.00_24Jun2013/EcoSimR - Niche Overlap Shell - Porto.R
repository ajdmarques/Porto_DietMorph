...
setwd("~/Documentos/Diet_Porto2022/Diet_Porto_Zenodo/EcoSimR_1.00_24Jun2013/")

## load EcoSimR
 
source("./EcoSimR - Main Source - Porto.R")

#############################################
## Model input parameters
## USER CAN MODIFY PARAMETERS IN THIS SECTION
Data.File <- "site_pair.csv"
...
setwd("~/Documentos/Diet_Porto2022/Diet_Porto_Zenodo/")